...
echo "generating dataset: 5k reads of 10240 bases with 2% error rate"
./generate_dataset 5000 10240 2
echo "aligning..."
...
echo "generating dataset: 3k reads of 10240 bases with 5% error rate"
./generate_dataset 3000 10240 5
echo "aligning..."
